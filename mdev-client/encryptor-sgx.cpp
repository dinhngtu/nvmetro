...
static constexpr size_t MAX_VIRTUAL_QUEUES = 16;
static constexpr size_t NOTIFYFD_BURST = 16;
static constexpr int sleeppoll_ms = 100;
static constexpr long busypoll_ms = 500;
static constexpr unsigned int busypoll_loops = 20;
...
static void worker_func(
    ...
    nvme_encryptor_sgx controller(vm, sqfds.front(), bfd, esopath, false, key, arg_lba_shift);
