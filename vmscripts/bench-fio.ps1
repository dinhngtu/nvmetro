...
$Scenarios = @{
    ...
    "lat-bs512-trandread-iod1-j1"       = @("--bs=512", "--rw=randread", "--iodepth=1", "--numjobs=1", "--rate_iops=10000");
    "lat-bs512-trandread-iod128-j1"     = @("--bs=512", "--rw=randread", "--iodepth=128", "--numjobs=1", "--rate_iops=10000");
    ...
    "lat-bs512-trandread-iod4-j1"       = @("--bs=512", "--rw=randread", "--iodepth=4", "--numjobs=1", "--rate_iops=10000");
    "lat-bs512-trandread-iod32-j1"      = @("--bs=512", "--rw=randread", "--iodepth=32", "--numjobs=1", "--rate_iops=10000");
